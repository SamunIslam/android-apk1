...
interface zzir {
    ...
    void zza(int i, zzdv zzdvVar) throws IOException;

    <K, V> void zza(int i, zzge<K, V> zzgeVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzhc zzhcVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzhc zzhcVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzhc zzhcVar) throws IOException;

    void zzb(int i, List<zzdv> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzhc zzhcVar) throws IOException;

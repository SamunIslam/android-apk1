...
public interface zzhd {
    ...
    <T> T zza(zzhc<T> zzhcVar, zzeq zzeqVar) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzhc<T> zzhcVar, zzeq zzeqVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzge<K, V> zzgeVar, zzeq zzeqVar) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzhc<T> zzhcVar, zzeq zzeqVar) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzhc<T> zzhcVar, zzeq zzeqVar) throws IOException;

...
final class zzep extends zzdp<Double> implements zzfk<Double>, zzgz, RandomAccess {
    ...
    private zzep(double[] dArr, int i) {
        this.zzb = dArr;
        this.zzc = i;
    }
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.zzc; i2++) {
            i = (i * 31) + zzfe.zza(Double.doubleToLongBits(this.zzb[i2]));
        }
        return i;
    }
    ...
    public final /* synthetic */ zzfk<Double> zza(int i) {
        if (i < this.zzc) {
            throw new IllegalArgumentException();
        }
        return new zzep(Arrays.copyOf(this.zzb, i), this.zzc);
    }
    ...
    static {
        zzep zzepVar = new zzep(new double[0], 0);
        zza = zzepVar;
        zzepVar.j_();
    }
}

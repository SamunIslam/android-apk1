...
public class zzhh<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    private final int zza;
    private List<zzhm> zzb;
    private Map<K, V> zzc;
    private boolean zzd;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <FieldDescriptorType extends zzev<FieldDescriptorType>> zzhh<FieldDescriptorType, Object> zza(int i) {
        return new zzhg(i);
    }
    ...
    public boolean containsKey(Object obj) {
        ...
        return zza((zzhh<K, V>) comparable) >= 0 || this.zzc.containsKey(comparable);
    }
    ...
    public V get(Object obj) {
        Comparable comparable = (Comparable) obj;
        int zza = zza((zzhh<K, V>) comparable);
        if (zza >= 0) {
    ...
    public final V zza(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzhm remove = this.zzb.remove(i2 - 1);
            zzg().put((K) remove.getKey(), (V) remove.getValue());
        }
        this.zzb.add(i, new zzhm(this, k, v));
        return null;
    }
    ...
    public final V zzc(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            this.zzb.add(new zzhm(this, it.next()));
            it.remove();
        }
        return v;
    }
    ...
    public boolean equals(Object obj) {
        ...
        int size = size();
        if (size != zzhhVar.size()) {
            return false;
        }
        int zzc = zzc();
        if (zzc != zzhhVar.zzc()) {
            return entrySet().equals(zzhhVar.entrySet());
        }
        for (int i = 0; i < zzc; i++) {
            if (!zzb(i).equals(zzhhVar.zzb(i))) {
                return false;
            }
        }
        if (zzc != size) {
            return this.zzc.equals(zzhhVar.zzc);
        }
        return true;
    }
    ...
    public /* synthetic */ Object put(Object obj, Object obj2) {
        return zza((zzhh<K, V>) ((Comparable) obj), (Comparable) obj2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public /* synthetic */ zzhh(int i, zzhg zzhgVar) {
        this(i);
    }
}

...
final class zzhb<E> extends zzdp<E> implements RandomAccess {
    private static final zzhb<Object> zza;
    private E[] zzb;
    private int zzc;

    public static <E> zzhb<E> zzd() {
        return (zzhb<E>) zza;
    }
    ...
    static {
        zzhb<Object> zzhbVar = new zzhb<>(new Object[0], 0);
        zza = zzhbVar;
        zzhbVar.j_();
    }
}

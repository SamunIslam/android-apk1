...
public final class zzzz {
    ...
    public static final zzzk<Integer> zzcjc = zzzk.zza(1, "gads:video_exo_player:exo_player_precache_limit", (int) ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    public static final zzzk<Integer> zzcjd = zzzk.zza(1, "gads:video_exo_player:byte_buffer_precache_limit", (int) ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    ...
    public static void initialize(final Context context) {
        zzaze.zza(new zzdon(context) { // from class: com.google.android.gms.internal.ads.zzzy
            ...
            public final Object get() {
                return zzvj.zzpv().initialize(this.zzcit);
            }
        });
    }
